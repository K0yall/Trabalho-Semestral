...
<head>
    ...
    <title>Avaliação da Alimentação</title>
...
<body>
    <div class="container">
        <div class="evaluation-box">
            <h1>Avaliação da Alimentação</h1>
            <p>Como você avalia a alimentação oferecida pelo nosso hospital?</p>
            <br>
            <form action="avaliacao_recepcao.php" method="post">
