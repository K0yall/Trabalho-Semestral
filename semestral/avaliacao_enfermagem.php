...
<head>
    ...
    <title>Avaliação do Setor de Enfermagem</title>
...
<body>
    <div class="container">
        <div class="evaluation-box">
            <h1>Avaliação do Setor de Enfermagem</h1>
            <p>Como você avalia o atendimento do nosso setor de enfermagem?</p>
            <br>
            <form action="avaliacao_alimentacao.php" method="post">
